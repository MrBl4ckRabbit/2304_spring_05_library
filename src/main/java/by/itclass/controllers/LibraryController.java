...
public class LibraryController {
    ...
    @GetMapping("/view/{id}")
    public String viewLibrary(@PathVariable(name = "id") int id,
                              Model model) {
    ...
    @PostMapping("/add-old")
    public String addOld(@RequestParam(name = "name") String name,
    ...
    @PostMapping("/upd-old")
    public String updateOld(@RequestParam(name = "id") int id,
