...
public class BookController {
    ...
    public String saveBookOld(@RequestParam(name = "title") String title,
    ...
    public String deleteBook(@PathVariable(name = "book_Id") int bookId,
    ...
    public String deleteBookSecond(@PathVariable(name = "book_Id") int bookId) {
    ...
    public String updateBookOld(@RequestParam(name = "id") int id,
